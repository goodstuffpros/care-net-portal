...
const ALL_LESSONS: Lesson[] = [
  ...
  { id: "mod10_notifications", title: "Notifications — Settings & Alerts", subtitle: "Module 10 · Daily Use",    image: `${API_BASE}/university/new_cg_messages.jpg`,         narration: "Tap the bell in the top right to see all your alerts. Red alerts require immediate attention — these include urgent Care Log entries, schedule changes added by the family, and new medications. Yellow flags are informational. Configure which alerts you receive in your notification settings to keep your feed focused.", duration: "2 min", knowledgePoints: 3 },
  ...
  { id: "mod_documents",     title: "Document Vault",                      subtitle: "Module · Daily Use",         image: `${API_BASE}/university/new_cg_documents.jpg`,             narration: "The Document Vault is a secure place to store anything important to the care relationship — insurance cards, advance directives, medication lists, physician letters, and identification documents. Upload a file by tapping Add Document, choose the category, and save. Confidential documents are marked with a lock and only visible to caregivers. Family members can view non-confidential uploads at any time.", duration: "2 min", knowledgePoints: 3 },
  { id: "fc_documents",     title: "Document Vault",                      subtitle: "Family Track · Documents",    image: `${API_BASE}/university/new_fc_documents.jpg`,             narration: "The Document Vault holds important records for your loved one's care — insurance cards, medical letters, advance directives, and more. As Main Contact, you can upload documents directly. Your caregiver will be able to see and reference them. Confidential items are marked with a lock.", duration: "1 min", knowledgePoints: 2 },
  { id: "mod13_media",       title: "Media Library",                      subtitle: "Module 13 · Daily Use",      image: `${API_BASE}/university/new_cg_media.jpg`,        narration: "The Media Library is a shared space for photos and documents relevant to your client's care. Upload wound photos, therapy materials, identification documents, or any visual record that helps the family stay informed. All authorized care team members can view what has been uploaded.", duration: "2 min", knowledgePoints: 3 },
  { id: "mod14_outings",     title: "Outings — Planning & Logging",       subtitle: "Module 14 · Daily Use",      image: `${API_BASE}/university/new_cg_outings.jpg`,         narration: "Outings let you plan and document time outside the home. Add the destination, planned duration, and any preparation notes beforehand. After the outing, log how it went — including the client's response, any notable moments, and whether a follow-up is needed. Families appreciate this documentation.", duration: "2 min", knowledgePoints: 3 },
  ...
  { id: "mod17_handoff",    title: "Shift Handoff — End-of-Shift Summary", subtitle: "Module 17 · Daily Use", image: `${API_BASE}/university/new_cg_schedule.jpg`, narration: "The Shift Handoff pulls together everything from your current shift into a single report. Tap Generate Report and CareNet will compile the medications administered, any Care Log incidents, the client's mood and activity, upcoming schedule items, and open notes — all in one place. You can add a personal message before submitting. The incoming caregiver and family receive it automatically. A completed handoff is one of the most professional things you can do at the end of a shift.", duration: "3 min", knowledgePoints: 4 },
  { id: "mod18_caregivers",  title: "Care Team — Managing Access",         subtitle: "Module 18 · Setup",     image: `${API_BASE}/university/new_cg_messages.jpg`, narration: "The Care Team page shows everyone with access to this client's portal — caregivers, family members, and contacts. To add a new caregiver, tap Add Member and enter their name and email. They will receive an invitation to join. You can also remove access for anyone who is no longer part of the care team. Keeping this list current ensures the right people see the right information.", duration: "2 min", knowledgePoints: 3 },
