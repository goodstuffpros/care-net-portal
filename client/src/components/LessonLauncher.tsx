...
const ALL_LESSONS: Lesson[] = [
  ...
  { id: "mod12_archive",     title: "Archive & CareNet Summaries",             subtitle: "Module 12 · Daily Use",      image: `${API_BASE}/university/seed_mod12_archive.jpg`,          narration: "The Archive stores all past shift summaries and generated reports. Tap Generate Summary — the green button — to create a new report from recent Care Log entries and Schedule data. CareNet reads the documentation and produces a structured summary you can share with family, physicians, or agencies.", duration: "4 min", knowledgePoints: 5 },
  { id: "mod_documents",     title: "Document Vault",                      subtitle: "Module · Daily Use",         image: `${API_BASE}/university/seed_mod13_media.jpg`,             narration: "The Document Vault is a secure place to store anything important to the care relationship — insurance cards, advance directives, medication lists, physician letters, and identification documents. Upload a file by tapping Add Document, choose the category, and save. Confidential documents are marked with a lock and only visible to caregivers. Family members can view non-confidential uploads at any time.", duration: "2 min", knowledgePoints: 3 },
  { id: "fc_documents",     title: "Document Vault",                      subtitle: "Family Track · Documents",    image: `${API_BASE}/university/seed_mod13_media.jpg`,             narration: "The Document Vault holds important records for your loved one's care — insurance cards, medical letters, advance directives, and more. As Main Contact, you can upload documents directly. Your caregiver will be able to see and reference them. Confidential items are marked with a lock.", duration: "1 min", knowledgePoints: 2 },
  ...
  { id: "mod17_handoff",    title: "Shift Handoff — End-of-Shift Summary", subtitle: "Module 17 · Daily Use", image: `${API_BASE}/university/seed_mod17_dashboard.jpg`, narration: "The Shift Handoff pulls together everything from your current shift into a single report. Tap Generate Report and CareNet will compile the medications administered, any Care Log incidents, the client's mood and activity, upcoming schedule items, and open notes — all in one place. You can add a personal message before submitting. The incoming caregiver and family receive it automatically. A completed handoff is one of the most professional things you can do at the end of a shift.", duration: "3 min", knowledgePoints: 4 },
  { id: "mod18_caregivers",  title: "Care Team — Managing Access",         subtitle: "Module 18 · Setup",     image: `${API_BASE}/university/seed_mod18_family_portal.jpg`, narration: "The Care Team page shows everyone with access to this client's portal — caregivers, family members, and contacts. To add a new caregiver, tap Add Member and enter their name and email. They will receive an invitation to join. You can also remove access for anyone who is no longer part of the care team. Keeping this list current ensures the right people see the right information.", duration: "2 min", knowledgePoints: 3 },
