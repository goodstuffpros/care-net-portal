...
const LESSONS: Record<ModuleKey, ModuleLesson> = {
  dashboard: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_dashboard.jpg`,
  ...
  "nav-overlay": {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_nav_overlay.jpg`,
  ...
  schedule: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_schedule.jpg`,
  ...
  "care-log": {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_carelog.jpg`,
  ...
  messages: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_messages.jpg`,
  ...
  vitals: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_vitals.jpg`,
  ...
  medications: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_medications.jpg`,
  ...
  archive: {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_archive.jpg`,
  ...
  documents: {
    title: "Documents",
    image: `${STATIC_BASE}/university/new_cg_documents.jpg`,
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_documents.jpg`,
  ...
  patterns: {
    ...
    image: `${STATIC_BASE}/university/new_cg_patterns.jpg`,
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_patterns.jpg`,
  ...
  "client-portal": {
    ...
    familyImage: `${STATIC_BASE}/university/new_fc_client_profile.jpg`,
...
export default function ModuleIntro({ moduleKey }: ModuleIntroProps) {
  ...
  const DEV_ALWAYS_SHOW = false; // flip true to re-enable review mode
